...
async def feynman(fo: FeynmanObject):
    instruction = f"""
    Evaluate the user's explanation using the Feynman technique. Pretend you're a helpful professor and provide constructive criticism without being overly formal. 
    Return:
    {{
      "clarity": (score /10),
      "accuracy": (score /10),
